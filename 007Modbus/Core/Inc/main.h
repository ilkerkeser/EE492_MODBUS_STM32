...
#define Role2_Pin GPIO_PIN_9
#define Role2_GPIO_Port GPIOD
#define Role1_Pin GPIO_PIN_13
#define Role1_GPIO_Port GPIOD
#define MOSFET2_Pin GPIO_PIN_6
#define MOSFET2_GPIO_Port GPIOC
#define MOSFET1_Pin GPIO_PIN_9
#define MOSFET1_GPIO_Port GPIOC
#define CS_Pin_Pin GPIO_PIN_7
